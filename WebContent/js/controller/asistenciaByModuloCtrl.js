app
		.controller(
				...
				function($scope, $http, $resource, $location, sharedProperties,
					...
					$scope.graficar = function graficar() {
						...
						asistenciaService
								.buscarByModuloCedula(
										...
										function success(miembroChartDto,
												status) {
					...
					$scope.warningLevel = function (resultado) {
						return resultado ? "label-success" : "label-danger";
						}
